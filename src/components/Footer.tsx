            ...
            <div className="space-y-6">
              <div>
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    <div className="text-lg font-extrabold bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">
                      Campaign Waala
                    </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3 group">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:support@campaignwaala.com"
            ...
            <div className="p-6 overflow-y-auto max-h-[70vh]">
              <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
                <p className="text-cyan-400 font-semibold">
                  ...
                  website by the name "Campaignwala" is owned by Campaignwala
                  and operated by Codessey. (together referred to
                  interchangeably as "we," "our," or "Campaignwala").
                  Campaignwala enables agents to sell various financial and
                  non-financial products and services such as Demat account,
                  credit, saving accounts, etc., through our technology platform
                ...
                <p>
                  ...
                  safeguard your information when you access and use our
                  Services through our website and mobile app (collectively
                  referred to as the "Platform") located at:
                  https://www.campaignwala.com/, which shall be incorporated
                  into and subject to the Terms of Service of the Platform and
                  shall be read harmoniously and in conjunction.
                </p>

                <p>
                  Our Platform and Services are primarily available for use
                  within India only.
                </p>
                ...
                <p>
                  ...
                  will treat it. Your continued use of our Platform is an
                  affirmation that you have read the Privacy Policy, understand
                  it, assent and consent to its terms and conditions, including
                  subsequent changes and amendments. If you do not agree to the
                ...
                <div>
                  ...
                  <p>
                    We collect Personal Information (as defined below) from you
                    when you register with us on our Platform. When you start
                    using the Services, we ask you to provide certain
                    information as part of the registration process and in the
                    course of your interaction with the Platform. Campaignwala
                    collects Personal Information when you visit/use/register
                    with Campaignwala, when you use emailed products or
                    services, when you visit Campaignwala pages or the pages of
                    certain Campaignwala partners, affiliates, or group
                    companies, and when you enter promotions or sweepstakes.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    We use the Personal and Non-Personal Information provided by
                    you to create your account, verify your identity, and
                    process your transactions on our Platform, customize the
                    advertising and content you see, provide personalized user
                    experience, fulfil your requests for products and services,
                    improve our services, contact you, conduct research, and
                    provide anonymous reporting for internal and external
                    clients.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Campaignwala does not rent, sell, or share personal
                    information about you with non-affiliated companies except
                    to provide the products or services you've requested, or
                    under the following circumstances: to trusted partners, to
                    comply with legal obligations, to protect the rights,
                    property, or safety of Campaignwala and its users, during
                    any corporate restructuring, or for any other purpose
                ...
                <div>
                  ...
                  <p>
                    ...
                    regarding our Privacy Policy, please reach out to us at:
                    <br />
                    <span className="text-cyan-400">
                      support@campaignwala.com
                    </span>
                  </p>
                  <p className="mt-3">
                    If you have any grievance or complaint with respect to our
                    Platform, please contact our Grievance Officer:
                    <br />
