...
export function Header({ currentPage, onNavigate }: HeaderProps) {
  ...
  // Bold background classes for both themes
  const headerBgClass = darkMode
    ? "bg-slate-900 shadow-xl"
    : "bg-white shadow-xl";

  // Optional: You can use gradients for more boldness (uncomment):
  // const headerBgClass = darkMode
  //   ? "bg-gradient-to-r from-slate-900 via-purple-900 to-slate-800 shadow-xl"
  //   : "bg-gradient-to-r from-white via-purple-100 to-white shadow-xl";
