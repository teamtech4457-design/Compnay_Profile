...
<div className="w-full max-w-sm bg-white dark:bg-gray-800 rounded-2xl shadow-xl dark:shadow-none overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-2xl dark:hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        {/* Header */}
