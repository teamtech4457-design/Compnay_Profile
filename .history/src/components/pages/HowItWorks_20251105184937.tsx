...
<div className="w-full max-w-sm bg-white dark:bg-card dark:border-card-border rounded-2xl shadow-xl overflow-hidden border border-gray-200 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                        {/* Header */}
