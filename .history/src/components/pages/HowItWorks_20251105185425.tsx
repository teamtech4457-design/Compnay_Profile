...
export function HowItWorks({ onNavigate }: HowItWorksProps) {
  ...
  {/* Card Content */}
  <div className="p-6 text-center bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-[var(--background)] dark:to-[var(--card)]">
    <h3 className="text-2xl font-bold text-gray-900 dark:text-[var(--card-foreground)] mb-2">Exciting Offers</h3>
    <p className="text-gray-600 dark:text-[var(--muted-foreground)] text-sm">Unlock amazing rewards</p>
  </div>
