    ...
    <div className="min-h-screen pt-20 bg-gradient-to-b from-[#0a0a1f] via-[#1a0a2e] to-[#0a0a1f]">
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-20 right-10 w-96 h-96 bg-purple-600/15 rounded-full blur-3xl animate-pulse" />
          <div className="absolute bottom-20 left-10 w-80 h-80 bg-pink-600/10 rounded-full blur-3xl animate-pulse" />
        </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8">
              ...
              {/* Contact Form */}
              <div className="bg-gradient-to-br from-gray-900/90 to-gray-800/90 rounded-3xl p-8 border-2 border-purple-500/30 backdrop-blur-lg">
                <div className="mb-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <Input
                      ...
                      required
                      className="bg-gray-800/60 border-2 border-purple-500/30 focus:border-cyan-500 rounded-xl px-4 py-3 placeholder:text-white/40 text-white"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      required
                      rows={5}
                      className="bg-gray-800/60 border-2 border-purple-500/30 focus:border-cyan-500 rounded-xl px-4 py-3 resize-none placeholder:text-white/40 text-white"
                    />
                  </div>
