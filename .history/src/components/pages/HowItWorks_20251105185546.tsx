                    ...
                    <div className="relative max-w-md mx-auto">
                      ...
                      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <div className="p-6 text-center bg-gradient-to-br from-blue-50 to-indigo-50">
                          ...
                          <p className="text-gray-600 text-sm">Unlock amazing rewards</p>
                        </div>
                        ...
                        <div className="p-6">
                          <div className="flex items-start space-x-3 mb-4">
                            ...
                            <div>
                              <h4 className="font-bold text-gray-900 text-lg">Zero-Fee Account</h4>
                              <p className="text-gray-600 text-sm mt-1">Start investing with no annual maintenance charges</p>
                            </div>
                          </div>
                    ...
                    <div className="relative max-w-md mx-auto">
                      ...
                      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <div className="p-6 space-y-6">
                         ...
                         <div className="w-full max-w-sm bg-white dark:bg-[var(--card)] rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-[var(--border)] hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
  <div className="p-6 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-[var(--background)] dark:to-[var(--card)] border-b border-gray-200 dark:border-[var(--border)]">
    <h3 className="text-xl font-bold text-gray-900 dark:text-[var(--card-foreground)] mb-2">Campaign Performance</h3>
    <p className="text-gray-600 dark:text-[var(--muted-foreground)] text-sm">Quick overview of your campaign performance</p>
  </div>
