                  ...
                  {step.title === "Find Your Offer" ? (
                    ...
                    <div className="relative max-w-md mx-auto">
                      ...
                      {/* Exciting Offers Card */}
                        ...
                        </div>                      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
