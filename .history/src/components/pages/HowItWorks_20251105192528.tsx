                ...
                <div className={`relative ${index % 2 === 1 ? "lg:order-2" : ""}`}>
                  {step.title === "Find Your Offer" ? (
                    ...
                    <div className="relative max-w-md mx-auto">
                     ...
                     export function ExcitingOfferCard() {
  return (
    <div className="w-full max-w-sm mx-auto rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 transition-all duration-300">
      {/* Header */}
      <div className="p-5 pt-6 text-center bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-800 dark:to-slate-950">
        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Exciting Offers</h3>
        <p className="text-gray-600 dark:text-slate-400 text-sm">Unlock amazing rewards</p>
      </div>
      ...
      <div className="p-5 pb-6">
        <div className="flex items-start space-x-3 mb-4">
          ...
          <div>
            <h4 className="font-bold text-gray-900 dark:text-white text-lg">Zero-Fee Account</h4>
            <p className="text-gray-600 dark:text-slate-400 text-sm mt-1">Start investing with no annual maintenance charges</p>
          </div>
        </div>

        {/* Earn Section */}
        <div className="bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-700 rounded-lg p-3 mb-4">
          <p className="text-green-800 dark:text-green-200 font-bold text-center text-sm">
            Earn ₹500 per lead
          </p>
        </div>
