                ...
                <div className={`relative ${index % 2 === 1 ? "lg:order-2" : ""}`}>
                  {step.title === "Find Your Offer" ? (
                    ...
                    <div className="relative max-w-md mx-auto">
                     ...
                     <div className="w-full max-w-sm bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                        <div className="p-6 text-center bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-gray-800">
                          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Exciting Offers</h3>
                          <p className="text-gray-600 dark:text-gray-300 text-sm">Unlock amazing rewards</p>
                        </div>
                        {/* बाकी कंटेंट */}
                      </div>
