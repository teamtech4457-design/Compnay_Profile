...
<div className="w-full max-w-sm bg-white dark:bg-gray-900 rounded-2xl shadow-xl dark:shadow-black/40 overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
  {/* Header */}
  <div className="p-6 text-center bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900">
    <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Exciting Offers</h3>
    <p className="text-gray-600 dark:text-gray-400 text-sm">Unlock amazing rewards</p>
  </div>
  ...
  <div className="p-6">
    <div className="flex items-start space-x-3 mb-4">
      ...
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">Start investing with no annual maintenance charges</p>
      </div>
    </div>
    ...
    {/* Share Button */}
    <button className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center gap-2 cursor-default">
      Share
